...
public class Fft {
     ...
     *
     * @param bits is a power of two such that 2^b is the number
     * of samples.
     */
    public Fft(int bits) {
     ...
     * @param xi is the imaginary part of the data to be transformed
     * (normally zero unless inverse transofrm is effect).
     * @param invFlag which is true if inverse transform is being
